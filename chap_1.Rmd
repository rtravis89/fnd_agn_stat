...
Set of subsets of $\Omega$, $S \subseteq \Omega$, that contain the relevent event(s). Must satisfy the following:

* Nonempty: $S \ne \emptyset$
* Closed under complements: if $A \in S$, then $A^c \in S$.
* Closed under countable unions: if $A_1,A-2,A-3,... \in S$ then $A_1 \cup A_2 \cup ... \in S$
